...
class produit extends \App\Entity\produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\produit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\produit' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\produit' . "\0" . 'photo', '' . "\0" . 'App\\Entity\\produit' . "\0" . 'quantite', '' . "\0" . 'App\\Entity\\produit' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\produit' . "\0" . 'paniers'];
        }
